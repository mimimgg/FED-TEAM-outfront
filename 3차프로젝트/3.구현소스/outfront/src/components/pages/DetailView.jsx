        ...
        <section>
          ...
          <div className="box">
              ...
              <ul className="mantine-Stack-root css-1rr4qq7 mantine-1kzvwqj">
                <li className="mantine-Group-root css-1n0sxg9 mantine-1yyyn9b">
                  <svg
                    ...
                    className="svg-inline--fa fa-circle-check css-z14cyq"
                    role="img"
            ...
            <div className="box-list4">
              ...
              <p>
                <a
                  href="http://inf-mindmap.s3-website.ap-northeast-2.amazonaws.com/inflearn-python-courses-807b09e61479572aac84b4130be7a6a2.html"
                  target="_blank"
              ...
              <p>
                <img
                  src="https://cdn.inflearn.com/public/files/courses/330551/8e3b0004-4d06-4495-a4de-3e43d4d877da/7.png"
                  alt=""
                  title="7.png"
                />
              </p>
              ...
              <div className="card-wrapper card-wrapper-3">
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/e5542339-5a11-42ba-93b1-1f131c8c9119/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
                      />
                    </p>
                ...
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/6ee5926e-0222-4bdd-95a2-107dab988b2d/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
                ...
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/ed0cf322-9ef6-4537-af3f-cc07b66e58f0/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
                ...
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/387e460e-2479-4f29-ac2c-b559c3e9dd40/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
                ...
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/9be395c8-0d98-4b2a-b48f-951213e11a67/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
                ...
                <div className="card-el">
                  <div>
                    <p>
                      <img
                        src="https://cdn.inflearn.com/public/files/courses/330551/9f8c407b-7cb7-437b-81b3-c2d5327ce1ed/blue-check.png"
                        alt=""
                        title="blue-check.png"
                        width="35"
                        height="35"
